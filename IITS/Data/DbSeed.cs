...
public static class DbSeed
{
    ...
    public static async Task EnsureAplicacionesOptionalColumnsAsync(this AppDbContext db, CancellationToken ct = default)
    {
        ...
        try
        {
            // Batch 1: ALTER TABLE — SQL Server valida columnas al compilar; datos en batch separado.
...
", ct);
        ...
        try
        {
            // Batch 2: EXEC() fuerza compilación diferida para columnas recién añadidas.
            await db.Database.ExecuteSqlRawAsync(@"
